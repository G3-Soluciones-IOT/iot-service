...
final class IotJwtAuthenticationConverter {

    private IotJwtAuthenticationConverter() {
    }

    static JwtAuthenticationConverter jwtAuthenticationConverter() {
        var authenticationConverter = new JwtAuthenticationConverter();
        authenticationConverter.setJwtGrantedAuthoritiesConverter(new IotGrantedAuthoritiesConverter());
        return authenticationConverter;
    }

    private static final class IotGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
        @Override
